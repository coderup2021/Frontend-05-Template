...
const PAUSE_TIME = Symbol("pause-time"); //总共暂停一共花费的时间
...
export class Animation {
	constructor(style, property, startValue, endValue, duration, delay, timingFunction, template) {
		this.style = style;
	...
	receive(time) {
		...
		this.style[this.property] = this.template(this.startValue + range * progress);
	}
}
